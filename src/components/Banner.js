...
export const Banner = () => {
    ...
    const toRotate = ['Back-end Developer', 'Cloud Architect', 'DevOps Engineer', 'Mobile Developer'];
    ...
    const tick = () => {
        ...
        setTimeout(() => setDelta(300 - Math.random() * 100), 3000);
    }
            ...
            <Container>
                <Row className="align-items-center">
                    <Col xs={12} md={6} xl={7}>
                        ...
                        <h1>Hi! I'm Carlo<br /><span className="wrap">{text}</span></h1>
                        <p>
